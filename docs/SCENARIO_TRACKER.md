...
| DS-05 | Large dataset handling | DS-C | 🟡 built (heavy query + EXPLAIN/DESCRIBE DETAIL profiling); not yet executed end-to-end |
...
| Data Scientist (DS) | 10* | 3 (DS-01/02/04) | 2 (DS-03/05) | 5 |
